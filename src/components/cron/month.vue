<template lang="html">
  <div :val="value_">
    <ta-radio-group v-model="type">
        <div>
            <ta-radio value="1">每月</ta-radio>
        </div>
        <div style="margin-top: 10px;">
            <ta-radio value="5">不指定</ta-radio>
        </div>
        <div style="margin-top: 10px;">
            <ta-radio value="2" border>周期</ta-radio>
            <span style="margin-left: 10px; margin-right: 5px;">从</span>
            <ta-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="12" style="width: 100px;"></ta-input-number>
            <span style="margin-left: 5px; margin-right: 5px;">至</span>
            <ta-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="12" style="width: 100px;"></ta-input-number>
            月
        </div>
        <div style="margin-top: 10px;">
            <ta-radio value="3">循环</ta-radio>
            <span style="margin-left: 10px; margin-right: 5px;">从</span>
            <ta-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="12" style="width: 100px;"></ta-input-number>
            <span style="margin-left: 5px; margin-right: 5px;">月开始，每</span>
            <ta-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="12" style="width: 100px;"></ta-input-number>
            月执行一次
        </div>
        <div style="display:flex;margin-top: 10px;">
            ...
            <ta-checkbox-group @change="(value) => {type ='4'; appoint = value}" :value="appoint" style="width: 600px;">
                <ta-row>
                    <ta-col :span="2" v-for="j in 12" :key="j">
